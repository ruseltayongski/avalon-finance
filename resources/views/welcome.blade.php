   ...
   <div class="container mx-auto pt-28">
      <div class="flex flex-wrap items-center xs:-mx-4">
         <div class="w-full px-4 lg:w-6/12 xl:w-7/12 pb-8">
            ...
            <div class="mx-auto text-center sm:container">
               <div class="shadow-product dark:shadow-box-dark mx-auto inline-flex justify-center rounded-md bg-white dark:bg-dark-2 py-7 px-5 sm:py-9 sm:px-10 sm:w-full">
                  <div class="-mx-3 flex items-center justify-center sm:-mx-6 md:-mx-10 lg:-mx-[50px]">
                     ...
                     <div class="relative px-3 text-center sm:px-6 md:px-10 lg:px-[50px] ">
                        ...
                        <span class="text-body-color dark:text-dark-6 text-[11px] xs:text-base">
                        Process Options
                        </span>
                     </div>
